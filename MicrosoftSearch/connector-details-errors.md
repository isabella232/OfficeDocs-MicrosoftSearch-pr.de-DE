...
ms.locfileid: "49905975"
---
<!-- markdownlint-disable no-inline-html -->

# <a name="view-connection-details-and-errors"></a>Anzeigen von Verbindungsdetails und Fehlern

Um auf Ihre Connectors zugreifen und diese verwalten zu können, müssen Sie als Suchadministrator für Ihren Mandanten festgelegt werden. Wenden Sie sich an Ihren Mandantenadministrator, um Die Rolle des Suchadministrators zu übernehmen.
...
1001 | Die Daten können nicht aktualisiert werden, da die Datenquelle den Connector drosselt. | Um die Datenquelle zu enthrottle, überprüfen Sie, ob ihre Skalierungsgrenzwerte erhöht werden können, oder warten Sie bis zu einer weniger datenverkehrslastigen Tageszeit.
...
1008 | Die Gesamtkontingentauslastung Ihres Mandanten hat seinen Grenzwert erreicht. | Versuchen Sie, eine Verbindung zu löschen, um einen Teil Ihres Kontingents frei zu geben, oder passen Sie Ihre Erfassungsfilter an, um weniger Daten einsenden zu können. Wenn diese das Problem nicht lösen, wenden Sie sich an den Microsoft-Support.
1009 | Die Gesamtkontingentauslastung für Ihre Verbindung hat ihren Grenzwert erreicht. | Versuchen Sie, Die Aufnahmefilter so anzupassen, dass weniger Daten ein- und einsenden werden. Wenn das Problem dadurch nicht behoben werden kann, wenden Sie sich an den Microsoft-Support.
...
2010 | Diese Verbindung ist aufgrund eines von Microsoft vorgenommenen Updates nicht mehr gültig. Löschen Sie die Verbindung, und erstellen Sie eine neue. | Löschen Sie die Verbindung, und erstellen Sie eine neue.
