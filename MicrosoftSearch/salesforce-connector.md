...
Sie können jetzt das [M365 Admin Center](https://admin.microsoft.com/) verwenden, um den restliche Setupprozess für Ihren Graph Connector abzuschließen.
